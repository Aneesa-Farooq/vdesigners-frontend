  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      var r,
        ...
        c = function (t, e, n) {
          ...
          for (o = e.length, r = n; n >= 0 && r < o; r += 1) if (e[r] === t) return r;
          return -1;
        };
    ...
    function (t, e, n) {
      ...
      function o(t, e, n) {
        var r;
        n = n || null;
        for (r in t) if (t.hasOwnProperty(r) && e.call(n, t[r], r, t) === !1) break;
      }
      function i(t, e, n) {
      ...
      function o(t, e) {
        ...
        (a.isUndefined(window.tui) || window.tui.usageStatistics !== !1) &&
          ((p && !r(p)) ||
            ...
            setTimeout(function () {
              ("interactive" !== document.readyState && "complete" !== document.readyState) || i(n, { v: 1, t: u, tid: e, cid: o, dp: o, dh: t, el: t, ec: s });
            }, 1e3)));
      }
      function i(t, e) {
        var n = s
    ...
    function (t, e) {
      ...
      var n,
        r,
        o = { chrome: !1, firefox: !1, safari: !1, msie: !1, edge: !1, others: !1, version: 0 },
        i = window.navigator,
    ...
    function (t, e, n) {
      ...
      function o(t, e, n) {
        ...
        return (
          (a = i.isDate(e) ? { year: e.getFullYear(), month: e.getMonth() + 1, date: e.getDate(), hour: e.getHours(), minute: e.getMinutes() } : { year: e.year, month: e.month, date: e.date, hour: e.hour, minute: e.minute }),
          !!r(a.year, a.month, a.date) &&
            ((a.meridiem = ""),
            /([^\\]|^)[aA]\b/.test(t) && ((o = a.hour > 11 ? h : f), a.hour > 12 && (a.hour %= 12), 0 === a.hour && (a.hour = 12), (a.meridiem = o)),
    ...
    function (t, e, n) {
      ...
      function r(t, e, n) {
        ...
        return (
          ...
          n ? ((a = r.pop()), (s = i.pick.apply(null, r)), (u = s[a] = e)) : i.extend(u, e),
          u
        );
      }
      var o = n(4),
    ...
    function (t, e, n) {
      ...
      (r.mixin = function (t) {
        ...
        (r.prototype._spliceMatches = function (t, e) {
          var n,
            r = 0;
          if (i.isArray(t)) for (n = t.length; r < n; r += 1) e(t[r]) === !0 && (t.splice(r, 1), (n -= 1), (r -= 1));
        }),
        ...
        (r.prototype._offByObject = function (t, e) {
          ...
          this._indexOfContext(t) < 0
            ...
            : i.isString(e)
            ? ((n = this._matchContext(t)), r._spliceMatches(this._safeEvent(e), n))
            : i.isFunction(e)

    ...
    <form @submit="submitForm" class="w-full flex flex-col items-center">
      <div class="flex w-full gap-6">
        <div class="flex flex-col flex-[1]">
          ...
          <router-link to="/user/Dashboard/dbAdmin" class="mt-[42px] w-full text-center self-start block bg-white border border-Green text-Green font-[700] text-lg cursor-pointer rounded-[7px] px-10 py-[10px] transition duration-[0.5s] hover:text-white hover:bg-Green">Back</router-link>
        </div>

    ...
    <div class="flex flex-col flex-[1] xl:flex-[2] h-screen p-6 relative items-center justify-center">
      <div class="w-full flex flex-col items-center max-w-[500px]">
        ...
        <!-- <button
          ...
          >
            <img
              class="self-start block w-auto h-full p-1 rounded-l-[7px]"
              src="../assets/googleIcon.jpg"
              alt="Google"
            />
            <p
              class="
        ...
        <form @submit="submitForm" class="w-full flex flex-col items-center max-w-[500px]">
          ...
          <InputField type="text" place_holder="Enter email" class="my-4" v-model="formValues.email" />
          ...
          <InputField place_holder="Enter Password" type="Password" class="my-4" v-model="formValues.password" />
          ...
          <div class="flex flex-col xl:flex-row gap-4 w-full xl:justify-between mt-4 xl:items-end my-[1.6rem]">
            ...
            <div class="flex items-center mt-1 gap-[.8rem] text-base font-normal">
              ...
              <router-link class="bg-transparent text-[#F33757] border-none cursor-pointer font-medium tracking-[.3px] hover:opacity-70"
